...
export default function RepositoryGrid({ repos, loading, emptyMessage = 'No repositories found.' }) {
  ...
  if (!repos || repos.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 px-4 text-center rounded-2xl border border-dashed border-border/50 bg-surface/20">
        <div className="w-12 h-12 flex items-center justify-center rounded-full bg-surface/50 border border-white/5 mb-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)]">
