...
const CATEGORIES = [
  { id: 'ai', name: 'AI & LLMs', label: 'AI', fallbackCount: 1420, icon: Cpu, color: 'from-purple-500/20 to-indigo-500/20', border: 'border-purple-500/30', text: 'text-purple-400' },
  { id: 'developer-tools', name: 'Developer Tools', label: 'Developer Tools', fallbackCount: 840, icon: Wrench, color: 'from-blue-500/20 to-cyan-500/20', border: 'border-blue-500/30', text: 'text-blue-400' },
  { id: 'databases', name: 'Databases & RAG', label: 'Databases', fallbackCount: 390, icon: HardDrive, color: 'from-emerald-500/20 to-teal-500/20', border: 'border-emerald-500/30', text: 'text-emerald-400' },
  { id: 'ai-agents', name: 'AI Agents', label: 'AI Agents', fallbackCount: 280, icon: Bot, color: 'from-amber-500/20 to-orange-500/20', border: 'border-amber-500/30', text: 'text-amber-400' },
  { id: 'libraries-frameworks', name: 'Libraries', label: 'Libraries & Frameworks', fallbackCount: 210, icon: Package, color: 'from-pink-500/20 to-rose-500/20', border: 'border-pink-500/30', text: 'text-pink-400' },
  { id: 'cloud-devops', name: 'Cloud & DevOps', label: 'Cloud & DevOps', fallbackCount: 160, icon: Cloud, color: 'from-sky-500/20 to-blue-500/20', border: 'border-sky-500/30', text: 'text-sky-400' },
  { id: 'security-auth', name: 'Security & Auth', label: 'Security', fallbackCount: 110, icon: ShieldCheck, color: 'from-red-500/20 to-amber-500/20', border: 'border-red-500/30', text: 'text-red-400' },
];

function CategoryChip({ cat, actualCount }) {
  const navigate = useNavigate();
  // Start with the actual count if available, otherwise use a minimal fallback to avoid fake huge numbers
...
export default function DiscoverLiveMetrics({ totalRepos = 0, categoryCounts = {} }) {
  ...
  // Derive initial value from prop but increment dynamically
