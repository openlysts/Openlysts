  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-20 sm:bottom-6 left-1/2 -translate-x-1/2 z-50 bg-bg-card/95 backdrop-blur-xl border border-border shadow-2xl rounded-2xl p-2 sm:p-3 flex items-center gap-2 sm:gap-4 w-[calc(100vw-1.25rem)] max-w-2xl"
      >
