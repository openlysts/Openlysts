        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <div style={{ flex: 1 }}>
              ...
              <select aria-label="Status" style={{ ...inputStyle, cursor: 'pointer' }} value={form.status} onChange={e => set('status', e.target.value)}>
          ...
          {goals.length > 0 && (
            <div>
              ...
              <select aria-label="Goal" style={{ ...inputStyle, cursor: 'pointer' }} value={form.goal_id} onChange={e => set('goal_id', e.target.value)} required>
