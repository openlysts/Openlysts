        ...
        <div className="flex items-center gap-2 self-start sm:self-auto">
          {user?.role?.toUpperCase() === 'ADMIN' && (
            <button
              ...
              className="px-4 py-2 rounded-xl bg-accent/10 hover:bg-accent/20 text-accent font-bold text-xs flex items-center gap-2 transition-all border border-accent/30 touch-target"
            >
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-nonoss-soft/60 hover:bg-nonoss-soft text-nonoss font-bold text-xs flex items-center gap-2 transition-all hover:-translate-y-0.5 border border-nonoss/20 touch-target"
          >
          ...
          <div className="card p-6 relative overflow-hidden space-y-5">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="relative group">
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-tr ${activePresetConfig.bg} p-0.5 shadow-xl flex items-center justify-center text-white cursor-pointer transition-transform group-hover:-translate-y-0.5`}
              ...
              {showAvatarPicker && (
                ...
                >
                  ...
                  <div className="space-y-1.5 pt-1">
                    <label htmlFor="custom-avatar-url" className="text-[10px] font-bold text-text-muted uppercase tracking-wider block">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="flex-1 min-w-0 bg-bg-card border border-border/80 rounded-xl px-3 py-2 text-xs text-text placeholder:text-text-muted focus:outline-none focus:border-accent"
                      />
                      <button
                        type="button"
                        onClick={() => handleSaveProfile(null, avatarPreset)}
                        className="px-3 py-2 rounded-xl bg-accent text-accent-fg font-bold text-xs hover:opacity-90 transition-all touch-target"
                      >
                        Apply
                      </button>
                    </div>
                    {customAvatarUrl && (
                      <div className="flex items-center gap-2 text-[10px] text-text-muted">
                        <img src={customAvatarUrl} alt="Avatar preview" className="w-6 h-6 rounded-full object-cover border border-border" onError={(e) => { e.currentTarget.style.visibility = 'hidden'; }} />
                        <span>Preview — shown in the header after saving.</span>
                      </div>
                    )}
                  </div>
                </motion.div>
