        ...
        <div className="lg:col-span-6 flex flex-col justify-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-text-secondary leading-relaxed max-w-md">
              Join developers discovering, comparing, and deploying cutting-edge open-source software before it hits mainstream.
            </p>
          </div>
        ...
        >
          ...
          >
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                <label htmlFor="register-name" className="block text-xs font-bold uppercase tracking-wider text-text-secondary mb-1.5">
                  Full Name
                </label>
              ...
              <div>
                <label htmlFor="register-email" className="block text-xs font-bold uppercase tracking-wider text-text-secondary mb-1.5">
                  Email Address
                </label>
                <div className="relative rounded-xl shadow-sm">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-text-muted">
              ...
              <div>
                <label htmlFor="register-password" className="block text-xs font-bold uppercase tracking-wider text-text-secondary mb-1.5">
                  Password
                </label>
                <div className="relative rounded-xl shadow-sm">
                  <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-text-muted">
