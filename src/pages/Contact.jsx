  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div data-tour="contact-methods" className="grid sm:grid-cols-2 gap-4 mb-10">
        <a href="#contact-form" className="card p-5 flex items-center gap-3 card-hover overflow-hidden">
          <div className="w-10 h-10 rounded-lg bg-accent-soft flex items-center justify-center flex-shrink-0">
            <Mail className="w-5 h-5 text-accent" />
          </div>
          <div className="min-w-0 flex-1">
            <h2 className="font-semibold text-text text-sm">In-app Contact Form</h2>
            <p className="text-text-muted text-sm">Support & Inquiries — fastest way to reach us</p>
          </div>
        </a>
        <a href="https://github.com/openlysts/Openlysts" target="_blank" rel="noopener noreferrer" className="card p-5 flex items-center gap-3 card-hover overflow-hidden">
          ...
          <div className="min-w-0 flex-1">
            <h2 className="font-semibold text-text text-sm">GitHub</h2>
            <p className="text-text-muted text-sm truncate">openlysts/Openlysts</p>
          </div>
        </a>
      </div>

      <form id="contact-form" onSubmit={(e) => { e.preventDefault(); handleEmail(); }} data-tour="contact-form" className="card p-6 space-y-4 scroll-mt-24">
        <div>
