...
5. **Established Openlysts Primitives**:
   - `src/components/openlyst/AnimateDigits.jsx`: Smooth spring-animated odometer digit ticker.
   - `src/components/openlyst/SocialHoverCards.jsx`: Direction-aware morphing hover preview popovers.
